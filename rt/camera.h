...
public:
	...
	camera(vec3 lookfrom, vec3 lookat, vec3 vup, float vfov, float aspect, float aperture, float focus_dist, Rnd & rnd) : _rnd(rnd) { // vfov is top to bottom in degrees
	...
	ray get_ray_pinhole(float s, float t) {
